...
TMUX_POWERLINE_SEG_NOW_PLAYING_SCROLL_METHOD_DEFAULT="roll"
...
export TMUX_POWERLINE_SEG_NOW_PLAYING_TRIM_METHOD="${TMUX_POWERLINE_SEG_NOW_PLAYING_SCROLL_METHOD_DEFAULT}"
